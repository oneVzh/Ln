...
final class Strings {
     ...
     * @return a string
     */
    static <T> String joinAnd(final String delimiter, final String lastDelimiter, final Collection<T> objs) {
    ...
    static <T> String joinAnd(final String delimiter, final String lastDelimiter, final T... objs) {
    ...
    static long copyLarge(Reader input, Writer output) throws RuntimeException {
        try {
    ...
    static boolean isEmpty(final Object o) {
